...
export type RuntimeStrategy = {id:string;plan:DCAPlan;slippageBps:number;status:"running"|"paused"|"blocked"|"completed";nextIndex:number;reservedUSDC:number;createdAt:string;updatedAt:string;runs:Run[];error?:string};
